...
InitializeVarsPrecaches()
{
    ...
    level._AssaultUpgNames = StrTok("Impertinent Deanimator,Red Fiend Bull,Parapetrifrier,Creeping Haze,Ruined Revenger,Waking Nightmare,Rift Breacher,Gravstone,Writ of Shamash,Fanged Doom,Nightmare Awakened 49",",");
    ...
    level._SMGUpgNames = StrTok("Nuevemuertes xx,Stellar 92,Sky Scorcher,Corpsemaker,Ghoul Keepers Subjucator,PieceDerResistance,Unseen VHand,Excisenin3fold,The Dark Impaler,Infernal Mercy,The Afterburner,SpeakEasy",",");
    ...
    level._TacticalUpgNames = StrTok("Dead Mans ReefRacker,Astralo-Packy-Cormus,Br-r-rah,Macho Manta VI,Quartermaster's Repeater,Skullpiercer",",");
    ...
    level._LMGUpgNames = StrTok("Cackling Kaftar,Acheron Alliterator,Tartarus Veil,Sumarbrander,Smilomegladon", ",");
    ...
    level._SniperUpgNames = StrTok("D3SOL0 Regulator,Righteous Fury,IT-5 LYT,Bakeneko,Cnemias Ablation,Arrythmic Dirge,Savage Razorback",",");
    ...
    level._PistolUpgNames = StrTok("Rapskallion 3D,Belle Of The Ball,Z-Harmony,King & Country,IM-PAK-D", ",");
    ...
    level._ShotgunUpgNames = StrTok("OMG Right Hook,Breccius Rebornus,M9-TKG Home Wrecker,Surgical Havoc,Ancient Harbinger", ",");
    ...
    level._BloodUpgWeapNames = StrTok("Magnus Operandi,Vitriolic Withering,The Sweeper,Hells Redeemer,Golden Spork Knife,Golden Scalpel,Attuned Spectral Shield,Tempered Blundergat", ",");
    ...
    level._IXWeaps = StrTok("ww_crossbow_t8,zhield_zword_dw",",");
    level._IXWeapNames = StrTok("Death of Orion,Brazen Bull",",");
    level._IXUpgWeapNames = StrTok("Serket Kiss,Iron Bull", ",");
    ...
    level._DeadUpgWeapNames = StrTok("Chaos Theory,Alistairs Annihilator", ",");
    level._AEWeaps = StrTok("ww_hand_o,ww_hand_h,ww_hand_g,ww_hand_c,Thunderstorm,zhield_zpear_dw",",");
    level._AEWeapNames = StrTok("Hand of Ouranous,Hand of Hemera,Hand of Gaia,Hand of Charon,Pegasus Strike,Apollo Will Shield",",");
    level._TagWeaps = StrTok("thundergun,ww_tesla_gun_t8,ww_tesla_sniper_t8,tundragun,snowball,snowball_yellow,music_box,eq_nesting_doll_grenade,zhield_dw",",");
    level._TagWeapNames = StrTok("Thundergun,Wonderwaffe DG2,Wonderwaffe Sniper,Tundragun,Snowballs,Yellow Snowballs,Samantha Box,Matryoska Dolls,Ballistic Shield",",");
    level._TagUpgWeaps = StrTok("thundergun_upgraded,ww_tesla_gun_t8_upgraded,ww_tesla_sniper_upgraded_t8,tundragun_upgraded,snowball_upgraded,snowball_yellow_upgraded",",");
    level._TagUpgWeapNames = StrTok("Zeus cannon,Wonderwaffe DG-3 JZ,Wunderwaffe DG-Funkenschutze,Boreas Blizzard,snowball upgraded,snowball yellow upgraded", ",");
    ...
    level._AOUpgWeaps = StrTok("ray_gun_mk2v_upgraded,ray_gun_mk2x_dw,ray_gun_mk2y_upgraded,ray_gun_mk2z_upgraded,galvaknuckles_t8,zhield_dw",",");
    level._ClassWeaps = StrTok("ww_Freezegun_t8,zhield_dw",",");
    level._ClassWeapNames = StrTok("Winters Howl,Ballistic Shield",",");
    level._ClassUpgWeapNames = StrTok("Winter's Fury", ",");
    ...
    level._MapUpgWeapsAetherNames   = StrTok("Porters X2 Ray Gun,Porters Mark II Ray Gun", ",");
